        ...
        init {
            itemView.setOnClickListener {
                ...
                when (position) {
                    ...
                    3 -> intent = Intent(context, SplinesActivity::class.java)
                    4 -> intent = Intent(context, CubeActivity::class.java)
                    5 -> intent = Intent(context, UnsharpMaskActivity::class.java)
                    6 -> intent = Intent(context, RetouchingActivity::class.java)
                    7 -> intent = Intent(context, InterpolationActivity::class.java)
                }
                intent = intent.apply {
                    putExtra(KEY, image)
                }
