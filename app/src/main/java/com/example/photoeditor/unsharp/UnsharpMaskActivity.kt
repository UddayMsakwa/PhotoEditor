package com.example.photoeditor.unsharp
...
import com.example.photoeditor.unsharp.model.UnsharpMaskAlgorithm
...
class UnsharpMaskActivity : AppCompatActivity() {
    ...
    private fun unsharp() {
        ...
        try {
            ...
            Log.d(DEBUG_TAG, "Algorithm completed")
            Toast.makeText(this, R.string.algorithm_success_message, Toast.LENGTH_SHORT).show()
        } catch (error: Exception) {
            Log.d(DEBUG_TAG, "An error occurred while running the algorithm: $error")
        ...
        try {
            ...
            Log.d(DEBUG_TAG, "An error occurred while saving the image")
